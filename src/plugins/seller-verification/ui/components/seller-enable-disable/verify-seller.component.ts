...
import { NotificationService, TypedBaseDetailComponent } from '@vendure/admin-ui/core';
  ...
  private saveChanges(): Observable<boolean> {
    if (this.detailForm.dirty) {
      ...
      return this.dataService
        .mutate<SetSellerVerificationStatusMutation, SetSellerVerificationStatusMutationVariables>(
